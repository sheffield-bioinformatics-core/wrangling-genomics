...
In a [previous lesson](https://github.com/RSE-Sheffield/hpc-shell-tuos-citc), you learned how to use the bash shell to interact with your computer through a command line interface. In this 
...
> ## Prerequisites
>
> This lesson assumes a working understanding of the bash shell. If you haven't already completed the [Introduction to the Shell for HPC ](https://github.com/RSE-Sheffield/hpc-shell-tuos-citc) lesson, and aren't familiar with the bash shell, please review those materials
